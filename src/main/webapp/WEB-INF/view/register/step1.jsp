...
<div style="background-color:#F4F4F4; padding:20px; width:500px" >
	<h2 style="font-family:Sans-Serif;">Terms and Agreements</h2>
	
	<textarea name="message" rows="13" cols="70" style="resize: none; wrap:hard; font-family:MS Gothic;">
Google 서비스 약관
...
Google에 문의하는 방법을 보려면 문의 페이지를 참조하시기 바랍니다.
	...
	<br>
	<label>
		<input style="font-family:Sans-Serif;" type="checkbox" name="agree" value="true"> Agree &nbsp;&nbsp;
	</label>
